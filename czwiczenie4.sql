...
--VALUES(1,ST_GeomFromText('LINESTRING(0 1, 1 1, 2 0, 3 1, 4 2, 5 1, 6 1)'),'obiekt1')

INSERT INTO obiekty
VALUES(2,ST_GeomFromText('CURVEPOLYGON(COMPOUNDCURVE(LINESTRING(10 6, 14 6), CIRCULARSTRING(14 6, 16 4, 14 2),CIRCULARSTRING(14 2, 12 0, 10 2),
						LINESTRING(10 2, 10 6)), CIRCULARSTRING(11 2, 13 2, 11 2))'),'obiekt2')
	   
--VALUES(2,ST_GeomFromText('CURVEPOLYGON((10 6, 14 6, 16 4, 14 2, 12 0, 10 2, 10 6),(11 2, 13 2, 11 2))'),'obiekt2')
